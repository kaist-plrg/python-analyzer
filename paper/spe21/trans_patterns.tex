...
multiplying it with the number of GPUs.
...
Figure \ref{fig:trans:sessrule} shows the key rule for the Session pattern,
which conducts the two transformations.
The transform rule matches an assign statement that stores the result of a
