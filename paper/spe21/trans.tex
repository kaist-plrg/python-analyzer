...
The Session pattern codes use the {\tt Session} object to define the 
computation environment.
The {\tt Session} objects are usually defined by {\tt with} statements,
and later used by calling the method {\tt Session.run}.
By calling the {\tt Sesison.run} method, the TensorFlow runtime can initiate the 
training computation on the computation graph.
...
The above transformation rule is formalized as shown in the figure 
