...
\begin{figure}[t!]
    ...
    \begin{subfigure}[b]{\textwidth}
      \lstinputlisting[style=mpythonscript]{tensorflow1_mnist.py}
      \caption{TensorFlow 1.x model example}
      \label{fig:back:tf1}
    \end{subfigure}   
    \begin{subfigure}[b]{\textwidth}
      \lstinputlisting[style=mpythonscript]{tensorflow2_ex.py}
...
Lines 13 to 19 train the model by iterating a loop over ten thousand datasets.
