...
Still, rewriting DL models with the frameworks manually is
time-consuming and labor-intensive.
It requires additional work, such as reading documents and code examples of
the frameworks, and modifying the training code using their APIs.
