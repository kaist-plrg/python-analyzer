...
\newcommand{\ktsubtysubs}[1]{{\tt\bf $<$:$_{#1}$}}
...
\newcommand{\cha}{{\sc Class Hierarchy Analyzer}}
\newcommand{\tapi}{{\sc Training API Pattern Analyzer}}
\newcommand{\atran}{{\sc AST Transformer}}
