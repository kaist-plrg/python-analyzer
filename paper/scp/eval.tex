...
\begin{inred}
In specific, the first author followed step-by-step instructions in the Horovod documentation
...
by our tool. 
If two codes are same except minor syntactic differences such as
