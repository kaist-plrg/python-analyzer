\subsection{Rule: TensorFlow 2.x Keras API Pattern}
...
\inden\inden\inden\smodenv[\lrscheduler $\mapsto$ \nidsubs{r}])\\
  ...
  \inden \ktelif ~ \nexprsubs{1} \ktsubty ~ {\tt tensorflow.keras.experimental.PiecewiseConstantDecay} ~ \ktthen\\
  \inden\inden 
  ([\nidsubs{r} \oassign \nexprsubs{1} \sparen{\nexprsubs{11} ... \nexprsubs{1n} ~ \op{(\nidsubs{1} \oassign)} \nexprsubs{21} ... \op{(\nidsubs{k} \oassign)} \nexprsubs{2k}} \optypcomm],\\
\inden\inden\inden\smodenv[\lrscheduler $\mapsto$ \nidsubs{r}])\\
  ...
  \inden\inden\inden\inden ... \op{(\nidsubs{k} \oassign)} \nexprsubs{2k}} \optypcomm], \smodenv[\lrscheduler $\mapsto$ \nidsubs{r}])\\
  \inden\inden \ktelse \\
  \inden\inden\inden ([\nidsubs{r} \oassign \nexprsubs{1} \sparen{\nexprsubs{11} {\tt * hvd.size()} ... \nexprsubs{1n} ~ \op{(\nidsubs{1} \oassign)} \nexprsubs{21} ... \op{(\nidsubs{k} \oassign)} \nexprsubs{2k}} \optypcomm], \\
  \inden\inden\inden\inden \smodenv[\lrscheduler $\mapsto$ \nidsubs{r}])\\


   % leraning rate scheduler TFv1

  \inden \ktelif ~ \nexprsubs{1} \ktsubty ~ {\tt tensorflow.compat.v1.train.exponential\_decay} ~ \ktthen\\
...
% Model
  ...
  \inden \ktelif ~ \nexprsubs{1} \ktsubty ~ {\tt tensorflow.keras.models.Model} ~ \ktthen\\
  \inden\inden 
  ([\nidsubs{r} \oassign \nexprsubs{1} \sparen{\nexprsubs{11} ... \nexprsubs{1n} ~ \op{(\nidsubs{1} \oassign)} \nexprsubs{21} ... \op{(\nidsubs{k} \oassign)} \nexprsubs{2k}} \optypcomm],\\
\inden\inden\inden\smodenv[\model $\mapsto$ \nidsubs{r}])\\
  ...
  \inden\inden \ktelse \\
  \inden\inden\inden ([\nidsubs{r} \oassign \nexprsubs{1} \sparen{\nexprsubs{11} ... \nexprsubs{1n} ~ \op{(\nidsubs{1} \oassign)} \nexprsubs{21} ... \op{(\nidsubs{k} \oassign)} \nexprsubs{2k} \\
  \inden\inden\inden ~ {\tt verbose} \oassign {\tt 1 if hvd.rank() == 0 else 0 }} \optypcomm], \smodenv)\\
...
\begin{tabular}{l}
  ...
  \inden \comment{Dataset in Assign}\\
